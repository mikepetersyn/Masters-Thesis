...
\input{2_mainmatter/4_generative_pattern_database/1_high_level_architecture.tex}

\input{2_mainmatter/4_generative_pattern_database/2_system_speification.tex}
