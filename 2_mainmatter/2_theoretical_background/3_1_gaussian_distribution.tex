...
\begin{figure}%
    ...
    \begin{subfigure}[b]{0.25\textwidth}%
        ...
        \input{tikz/gaussians/contour_plot_neg.tex}%
        \caption{}%
    ...
    \begin{subfigure}[b]{0.33\textwidth}%
        \centering\captionsetup{width=.8\linewidth}%
        \input{tikz/gaussians/contour_plot.tex}%
        \caption{}%
    ...
    \begin{subfigure}[b]{0.33\textwidth}%
        \centering\captionsetup{width=.8\linewidth}%
        \input{tikz/gaussians/contour_plot_pos.tex}%
        \caption{}%
...
\begin{figure}[b!]
    \centering
    \input{tikz/gaussians/marginal.tex}
