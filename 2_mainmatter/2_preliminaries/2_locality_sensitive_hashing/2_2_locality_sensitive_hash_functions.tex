...
\begin{algorithm}
 ...
 Choose $K$ such that $p_2^K = \frac{1}{N}, N = |\mathcal{P}|$. Let $\rho$ be the main parameter that determines the running time and space consumption of the algorithm. Assume that
