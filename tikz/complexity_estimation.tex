    ...
    \tikzstyle{component} = [rectangle, minimum width=2cm, minimum height=0.5cm, outer sep=0pt, align=flush center, draw=black, densely dotted]%
        ...
        \begin{tikzpicture}
            \begin{pgfonlayer}{foreground}
                \node (c_1_1) [circle, fill=red] {};
                \node (c_1_2) [circle, fill=blue, right = 0.25cm of c_1_1] {};
                ...
                \node (c_2_1) [circle, below=0.5cm of c_1_1, fill=blue] {};
                \node (c_2_2) [circle, fill=yellow, right = 0.25cm of c_2_1] {};
                \node (c_2_3) [circle, fill=red, right = 0.25cm of c_2_2] {};
                \node (set_2) [group, fit = {(c_2_1) (c_2_2) (c_2_3)}] {};
                \node (label_2) [left = 0.05cm of set_2] {$r=1001$};

                \node (c_3_1) [circle, below = 0.5cm of c_2_1 ,fill=blue] {};
            ...
            label={[xshift=-0.3cm, yshift=-0.1cm]\scriptsize $PDB_G[k_\delta]$, $k_\delta$ with $m=1$}] {}; 
            \begin{pgfonlayer}{background}
                ...
                label={[xshift=-1.2cm, yshift=-0.1cm]\scriptsize $PDB_{L_1}[k_\gamma]$}] {}; 
            \end{pgfonlayer}
            ...
            \begin{pgfonlayer}{foreground}
                \node (b_1_1) [circle, right=4.5cm of c_1_1, fill=yellow] {};
                \node (b_1_2) [circle, fill=red, right = 0.25cm of b_1_1] {};
                ...
                \node (b_3_1) [circle, below = 0.5cm of b_2_1 ,fill=blue] {};
                ...
                \node (b_4_1) [circle, below = 0.5cm of b_3_1 ,fill=red] {};
                \node (b_4_2) [circle, fill=blue, right = 0.25cm of b_4_1] {};
            ...
            \node (m_2_global) [component, fit={(label_b_1) (set_b_1) (set_b_4) (dots_2_above) (dots_2_below)}, fill=white, label={[xshift=-0.3cm, yshift=-0.1cm]\scriptsize $PDB_G[k_\delta]$, $k_\delta$ with $m=2$}] {}; 

            \begin{pgfonlayer}{background}
                \node (m_2_local) [component, fit={(label_b_1) (set_b_1) (set_b_4) (dots_2_above) (dots_2_below)}, fill=white, xshift=-0.5cm, yshift=0.5cm, fill=black!5, label={[xshift=-1.2cm, yshift=-0.1cm]\scriptsize $PDB_{L_2}[k_\gamma]$}] {};
            \end{pgfonlayer}

            \draw[arrow] (m_2_local.west) to [out=-180,in=180, xshift=-0.25cm, yshift=-0.25cm] (m_2_global.west);

            \node (g_1_1) [circle, right=2.5cm of b_1_1, fill=red] {};
            \node (g_1_2) [circle, fill=blue, right = 0.25cm of g_1_1] {};
            \node (g_1_3) [circle, fill=yellow, right = 0.25cm of g_1_2] {};
            ...
            \node (g_2_1) [circle, below=0.5cm of g_1_1, fill=red] {};
            \node (g_2_2) [circle, fill=yellow, right = 0.25cm of g_2_1] {};
            \node (g_2_3) [circle, fill=blue, right = 0.25cm of g_2_2] {};
            ...
            \node (g_3_1) [circle, below = 0.5cm of g_2_1 ,fill=blue] {};
            ...
            \node (g_4_1) [circle, below = 0.5cm of g_3_1 ,fill=red] {};
            \node (g_4_2) [circle, fill=blue, right = 0.25cm of g_4_1] {};
